...
def create_user():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during user creation: {e}'}), 500
...
def update_user(user_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during user update: {e}'}), 500
...
def delete_user(user_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during user deletion: {e}'}), 500
...
def create_workout():
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during workout creation: {e}'}), 500
...
def update_workout(workout_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during workout update: {e}'}), 500
...
def delete_workout(workout_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during workout deletion: {e}'}), 500
...
def create_exercise():
    ...
    name = data.get('name')
    exercise_type = data.get('type') # 'type' is a Python keyword, careful with variable naming
    ...
    except ValueError as e: # Catch specific ValueErrors if raised by your model's _init_
        db.session.rollback()
        return jsonify({'error': str(e)}), 400
    except Exception as e: # Catch any other unexpected errors
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during exercise creation: {e}'}), 500
...
def update_exercise(exercise_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during exercise update: {e}'}), 500
...
def delete_exercise(exercise_id):
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'error': f'An unexpected error occurred during exercise deletion: {e}'}), 500
